...
export const lessons: Lesson[] = [
  // Spanish — Unit 1
  {
    ...
    estimatedMinutes: 5,
    goals: [
      { id: 'es-g1', description: 'Greet someone in the morning, afternoon, and evening.' },
      { id: 'es-g2', description: 'Say goodbye politely.' },
    ],
    vocabulary: [
      { id: 'es-v1', word: 'Hola', translation: 'Hello', pronunciation: 'OH-lah' },
      { id: 'es-v2', word: 'Adiós', translation: 'Goodbye', pronunciation: 'ah-DYOHS' },
      { id: 'es-v3', word: 'Buenos días', translation: 'Good morning', pronunciation: 'BWEH-nohs DEE-ahs' },
      { id: 'es-v4', word: 'Buenas noches', translation: 'Good night', pronunciation: 'BWEH-nahs NOH-ches' },
    ],
    phrases: [
      { id: 'es-p1', phrase: '¡Hola! ¿Cómo estás?', translation: 'Hi! How are you?' },
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { id: 'es-v8', word: 'Mucho gusto', translation: 'Nice to meet you', pronunciation: 'MOO-choh GOOS-toh' },
    ],
    phrases: [
      { id: 'es-p3', phrase: 'Me llamo Ana.', translation: 'My name is Ana.' },
      { id: 'es-p4', phrase: '¿Cómo te llamas?', translation: 'What is your name?' },
  ...
  // Spanish — Unit 2
  {
    ...
    vocabulary: [
      ...
      { id: 'es-v11', word: 'Tres', translation: 'Three', pronunciation: 'trehs' },
      { id: 'es-v12', word: 'Cuatro', translation: 'Four', pronunciation: 'KWAH-troh' },
      { id: 'es-v13', word: 'Cinco', translation: 'Five', pronunciation: 'SEEN-koh' },
    ],
    phrases: [{ id: 'es-p6', phrase: 'Tengo cinco libros.', translation: 'I have five books.' }],
    activities: [
      {
        id: 'es-a4',
        type: 'matching',
  ...
  },
  {
    ...
    xpReward: 10,
    estimatedMinutes: 5,
    goals: [{ id: 'es-g6', description: 'Use please and thank you naturally in Spanish.' }],
    vocabulary: [
      { id: 'es-v14', word: 'Por favor', translation: 'Please', pronunciation: 'por fah-VOR' },
      { id: 'es-v15', word: 'Gracias', translation: 'Thank you', pronunciation: 'GRAH-syahs' },
      { id: 'es-v16', word: 'De nada', translation: 'You\'re welcome', pronunciation: 'deh NAH-dah' },
    ],
    phrases: [
      { id: 'es-p7', phrase: 'Un café, por favor.', translation: 'A coffee, please.' },
      { id: 'es-p8', phrase: 'Muchas gracias.', translation: 'Thank you very much.' },
    ],
    activities: [
      {
        id: 'es-a5',
  ...
  },
  {
    ...
    vocabulary: [
      { id: 'es-v17', word: 'Agua', translation: 'Water', pronunciation: 'AH-gwah' },
      { id: 'es-v18', word: 'Café', translation: 'Coffee', pronunciation: 'kah-FEH' },
      { id: 'es-v19', word: 'Quiero', translation: 'I want', pronunciation: 'KYEH-roh' },
    ],
    phrases: [
      { id: 'es-p9', phrase: 'Quiero un café.', translation: 'I want a coffee.' },
  ...
  // French — Unit 1
  {
    ...
    xpReward: 10,
    estimatedMinutes: 5,
    goals: [{ id: 'fr-g1', description: 'Greet someone formally and informally in French.' }],
    vocabulary: [
      { id: 'fr-v1', word: 'Bonjour', translation: 'Hello / Good day', pronunciation: 'bohn-ZHOOR' },
      { id: 'fr-v2', word: 'Bonsoir', translation: 'Good evening', pronunciation: 'bohn-SWAR' },
      { id: 'fr-v3', word: 'Salut', translation: 'Hi (informal)', pronunciation: 'sah-LOO' },
      { id: 'fr-v4', word: 'Au revoir', translation: 'Goodbye', pronunciation: 'oh ruh-VWAR' },
    ],
    phrases: [
      { id: 'fr-p1', phrase: 'Bonjour! Comment allez-vous?', translation: 'Hello! How are you? (formal)' },
      { id: 'fr-p2', phrase: 'Salut! Ça va?', translation: 'Hi! How\'s it going?' },
    ],
    activities: [
      {
        id: 'fr-a1',
  ...
  },
  {
    ...
    xpReward: 10,
    estimatedMinutes: 6,
    goals: [{ id: 'fr-g2', description: 'Introduce yourself and ask for a name in French.' }],
    vocabulary: [
      { id: 'fr-v5', word: 'Je', translation: 'I', pronunciation: 'zhuh' },
      { id: 'fr-v6', word: 'Je m\'appelle', translation: 'My name is', pronunciation: 'zhuh mah-PELL' },
      { id: 'fr-v7', word: 'Enchanté', translation: 'Nice to meet you (m.)', pronunciation: 'ahn-shahn-TAY' },
    ],
    phrases: [
      { id: 'fr-p3', phrase: 'Je m\'appelle Marie.', translation: 'My name is Marie.' },
      { id: 'fr-p4', phrase: 'Comment tu t\'appelles?', translation: 'What is your name? (informal)' },
    ],
    activities: [
      {
        id: 'fr-a2',
  ...
  // French — Unit 2
  {
    ...
    vocabulary: [
      { id: 'fr-v8', word: 'Je voudrais', translation: 'I would like', pronunciation: 'zhuh voo-DRAY' },
      { id: 'fr-v9', word: 'Une baguette', translation: 'A baguette', pronunciation: 'oon bah-GET' },
      { id: 'fr-v10', word: 'L\'eau', translation: 'Water', pronunciation: 'loh' },
    ],
    phrases: [
      { id: 'fr-p5', phrase: 'Je voudrais une baguette, s\'il vous plaît.', translation: 'I would like a baguette, please.' },
      { id: 'fr-p6', phrase: 'L\'addition, s\'il vous plaît.', translation: 'The check, please.' },
    ],
    activities: [
      {
        id: 'fr-a3',
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { id: 'fr-v12', word: 'La gare', translation: 'The train station', pronunciation: 'lah gar' },
      { id: 'fr-v13', word: 'Le métro', translation: 'The subway', pronunciation: 'luh may-TROH' },
    ],
    phrases: [
      { id: 'fr-p7', phrase: 'Où est la gare?', translation: 'Where is the train station?' },
  ...
  },
  {
    ...
    vocabulary: [
      ...
      { id: 'fr-v16', word: 'Trois', translation: 'Three', pronunciation: 'trwah' },
      { id: 'fr-v17', word: 'Dix', translation: 'Ten', pronunciation: 'deess' },
    ],
    phrases: [{ id: 'fr-p9', phrase: 'J\'ai trois frères.', translation: 'I have three brothers.' }],
    activities: [
      {
        id: 'fr-a5',
        type: 'matching',
  ...
  // Japanese — Unit 1
  {
    ...
    xpReward: 10,
    estimatedMinutes: 5,
    goals: [{ id: 'ja-g1', description: 'Use basic Japanese greetings politely.' }],
    vocabulary: [
      { id: 'ja-v1', word: 'こんにちは', translation: 'Hello', pronunciation: 'kohn-nee-chee-WAH' },
      ...
      { id: 'ja-v4', word: 'おはよう', translation: 'Good morning (informal)', pronunciation: 'oh-HAH-yoh' },
    ],
    phrases: [
      { id: 'ja-p1', phrase: 'こんにちは！', translation: 'Hello!' },
      { id: 'ja-p2', phrase: 'ありがとうございます。', translation: 'Thank you very much.' },
    ],
    activities: [
      {
        id: 'ja-a1',
  ...
  },
  {
    ...
    vocabulary: [
      { id: 'ja-v5', word: 'わたし', translation: 'I (polite)', pronunciation: 'wah-TAH-shee' },
      { id: 'ja-v6', word: '名前', translation: 'Name', pronunciation: 'nah-MAH-eh' },
      { id: 'ja-v7', word: '〜です', translation: 'I am ~ (polite)', pronunciation: 'dess' },
    ],
    phrases: [
      { id: 'ja-p3', phrase: 'わたしはサラです。', translation: 'I am Sara.' },
      { id: 'ja-p4', phrase: 'はじめまして。', translation: 'Nice to meet you.' },
      { id: 'ja-p5', phrase: 'よろしくお願いします。', translation: 'Please treat me well. (Nice to meet you.)' },
    ],
    activities: [
      {
        id: 'ja-a2',
  ...
  // Japanese — Unit 2
  {
    ...
    phrases: [{ id: 'ja-p6', phrase: 'りんごが三つあります。', translation: 'There are three apples.' }],
    activities: [
      {
        id: 'ja-a3',
        type: 'matching',
  ...
  },
  {
    ...
    xpReward: 10,
    estimatedMinutes: 5,
    goals: [{ id: 'ja-g4', description: 'Say excuse me and sorry appropriately.' }],
    vocabulary: [
      { id: 'ja-v13', word: 'すみません', translation: 'Excuse me / Sorry', pronunciation: 'soo-mee-mah-SEN' },
      { id: 'ja-v14', word: 'ごめんなさい', translation: 'I\'m sorry', pronunciation: 'goh-men-nah-SAI' },
    ],
    phrases: [
      { id: 'ja-p7', phrase: 'すみません、トイレはどこですか。', translation: 'Excuse me, where is the restroom?' },
  ...
  },
  {
    ...
    vocabulary: [
      { id: 'ja-v15', word: 'いくら', translation: 'How much', pronunciation: 'ee-KOO-rah' },
      { id: 'ja-v16', word: 'これ', translation: 'This', pronunciation: 'KOH-reh' },
      { id: 'ja-v17', word: 'ください', translation: 'Please give me', pronunciation: 'koo-dah-SAI' },
    ],
    phrases: [
      { id: 'ja-p9', phrase: 'これはいくらですか。', translation: 'How much is this?' },
      { id: 'ja-p10', phrase: 'これをください。', translation: 'This one, please.' },
    ],
    activities: [
      {
        id: 'ja-a5',
  ...
  },
  {
    ...
    xpReward: 10,
    estimatedMinutes: 6,
    goals: [{ id: 'es-g9', description: 'Ask where a place is located in Spanish.' }],
    vocabulary: [
      { id: 'es-v20', word: '¿Dónde está?', translation: 'Where is...?' },
      { id: 'es-v21', word: 'La estación', translation: 'The station' },
    ],
    phrases: [{ id: 'es-p11', phrase: '¿Dónde está la estación?', translation: 'Where is the station?' }],
    activities: [{ id: 'es-a8', type: 'listening', title: 'Directions', prompt: 'Listen and pick the correct direction.' }],
    aiTeacher: createAITeacherPrompt('Spanish', 'travel and directions', "Let's practice finding your way in Spanish."),
  },
  {
    id: 'es-lesson-7',
    unitId: 'unit-es-2',
    ...
    vocabulary: [
      { id: 'es-v22', word: '¿Cuánto cuesta?', translation: 'How much does it cost?' },
      { id: 'es-v23', word: 'Tienda', translation: 'Store' },
    ],
    phrases: [{ id: 'es-p12', phrase: '¿Cuánto cuesta esto?', translation: 'How much does this cost?' }],
    activities: [{ id: 'es-a9', type: 'speaking', title: 'At the shop', prompt: 'Ask the price of an item.' }],
    aiTeacher: createAITeacherPrompt('Spanish', 'shopping phrases', "Time to practice shopping in Spanish."),
  },
  {
    id: 'es-lesson-8',
    unitId: 'unit-es-2',
    ...
    phrases: [{ id: 'es-p13', phrase: 'Mi familia es grande.', translation: 'My family is big.' }],
    activities: [{ id: 'es-a10', type: 'matching', title: 'Family words', prompt: 'Match family vocabulary.' }],
    aiTeacher: createAITeacherPrompt('Spanish', 'family and friends vocabulary', "Let's talk about the people you love."),
  },
  {
    id: 'ko-lesson-1',
    unitId: 'unit-ko-1',
    ...
    activities: [{ id: 'ko-a1', type: 'speaking', title: 'Say hello', prompt: 'Repeat the greeting.' }],
    aiTeacher: createAITeacherPrompt('Korean', 'basic greetings', "Let's start with Korean greetings."),
  },
  {
    id: 'ko-lesson-2',
    unitId: 'unit-ko-1',
    ...
    phrases: [{ id: 'ko-p2', phrase: '감사합니다.', translation: 'Thank you.' }],
    activities: [{ id: 'ko-a2', type: 'listening', title: 'Daily phrases', prompt: 'Choose the correct response.' }],
    aiTeacher: createAITeacherPrompt('Korean', 'daily life phrases', "Let's practice everyday Korean."),
  },
  {
    id: 'ko-lesson-3',
    unitId: 'unit-ko-1',
    ...
    phrases: [{ id: 'ko-p3', phrase: '커피 한 잔 주세요.', translation: 'One coffee, please.' }],
    activities: [{ id: 'ko-a3', type: 'speaking', title: 'Order coffee', prompt: 'Place a simple order.' }],
    aiTeacher: createAITeacherPrompt('Korean', 'ordering at a café', "Let's practice at a Korean café."),
  },
  {
    id: 'ko-lesson-4',
    unitId: 'unit-ko-2',
    ...
    phrases: [{ id: 'ko-p4', phrase: '화장실이 어디예요?', translation: 'Where is the restroom?' }],
    activities: [{ id: 'ko-a4', type: 'listening', title: 'Directions', prompt: 'Pick the right direction phrase.' }],
    aiTeacher: createAITeacherPrompt('Korean', 'directions', "Let's find our way in Korean."),
  },
  {
    id: 'ko-lesson-5',
    unitId: 'unit-ko-2',
    ...
    vocabulary: [{ id: 'ko-v5', word: '얼마예요?', translation: 'How much is it?' }],
    phrases: [{ id: 'ko-p5', phrase: '이거 얼마예요?', translation: 'How much is this?' }],
    activities: [{ id: 'ko-a5', type: 'speaking', title: 'Shopping', prompt: 'Ask for a price.' }],
    aiTeacher: createAITeacherPrompt('Korean', 'shopping', "Let's go shopping in Korean."),
  },
  {
    id: 'de-lesson-1',
    unitId: 'unit-de-1',
    ...
    phrases: [{ id: 'de-p1', phrase: 'Hallo! Wie geht es dir?', translation: 'Hello! How are you?' }],
    activities: [{ id: 'de-a1', type: 'speaking', title: 'Greet', prompt: 'Say hello in German.' }],
    aiTeacher: createAITeacherPrompt('German', 'greetings', "Let's learn German greetings."),
  },
  {
    id: 'de-lesson-2',
    unitId: 'unit-de-1',
    ...
    phrases: [{ id: 'de-p2', phrase: 'Danke schön.', translation: 'Thank you very much.' }],
    activities: [{ id: 'de-a2', type: 'listening', title: 'Daily life', prompt: 'Choose the correct phrase.' }],
    aiTeacher: createAITeacherPrompt('German', 'daily life', "Let's practice daily German."),
  },
  {
    id: 'de-lesson-3',
    unitId: 'unit-de-1',
    ...
    phrases: [{ id: 'de-p3', phrase: 'Einen Kaffee, bitte.', translation: 'A coffee, please.' }],
    activities: [{ id: 'de-a3', type: 'speaking', title: 'Order', prompt: 'Order a coffee.' }],
    aiTeacher: createAITeacherPrompt('German', 'café orders', "Let's order in German."),
  },
  {
    id: 'de-lesson-4',
    unitId: 'unit-de-2',
    ...
    phrases: [{ id: 'de-p4', phrase: 'Wo ist der Bahnhof?', translation: 'Where is the train station?' }],
    activities: [{ id: 'de-a4', type: 'listening', title: 'Directions', prompt: 'Pick the right answer.' }],
    aiTeacher: createAITeacherPrompt('German', 'directions', "Let's navigate in German."),
  },
  {
    id: 'de-lesson-5',
    unitId: 'unit-de-2',
    ...
    vocabulary: [{ id: 'de-v5', word: 'Wie viel kostet', translation: 'How much costs' }],
    phrases: [{ id: 'de-p5', phrase: 'Wie viel kostet das?', translation: 'How much does that cost?' }],
    activities: [{ id: 'de-a5', type: 'speaking', title: 'Shopping', prompt: 'Ask the price.' }],
    aiTeacher: createAITeacherPrompt('German', 'shopping', "Let's shop in German."),
  },
  {
    id: 'zh-lesson-1',
    unitId: 'unit-zh-1',
    ...
    activities: [{ id: 'zh-a1', type: 'speaking', title: 'Say hello', prompt: 'Repeat 你好.' }],
    aiTeacher: createAITeacherPrompt('Chinese', 'greetings', "Let's start with Mandarin greetings."),
  },
  {
    id: 'zh-lesson-2',
    unitId: 'unit-zh-1',
    ...
    activities: [{ id: 'zh-a2', type: 'listening', title: 'Daily phrases', prompt: 'Choose the correct phrase.' }],
    aiTeacher: createAITeacherPrompt('Chinese', 'daily life', "Let's practice daily Mandarin."),
  },
  {
    id: 'zh-lesson-3',
    unitId: 'unit-zh-1',
    ...
    phrases: [{ id: 'zh-p3', phrase: '我要一杯咖啡。', translation: 'I want a cup of coffee.' }],
    activities: [{ id: 'zh-a3', type: 'speaking', title: 'Order coffee', prompt: 'Place a simple order.' }],
    aiTeacher: createAITeacherPrompt('Chinese', 'café orders', "Let's order in Mandarin."),
  },
  {
    id: 'zh-lesson-4',
    unitId: 'unit-zh-2',
    ...
    phrases: [{ id: 'zh-p4', phrase: '地铁在哪里？', translation: 'Where is the subway?' }],
    activities: [{ id: 'zh-a4', type: 'listening', title: 'Directions', prompt: 'Pick the right phrase.' }],
    aiTeacher: createAITeacherPrompt('Chinese', 'directions', "Let's navigate in Mandarin."),
  },
  {
    id: 'zh-lesson-5',
    unitId: 'unit-zh-2',
    ...
    vocabulary: [{ id: 'zh-v5', word: '多少钱', translation: 'How much money' }],
    phrases: [{ id: 'zh-p5', phrase: '这个多少钱？', translation: 'How much is this?' }],
    activities: [{ id: 'zh-a5', type: 'speaking', title: 'Shopping', prompt: 'Ask the price.' }],
    aiTeacher: createAITeacherPrompt('Chinese', 'shopping', "Let's shop in Mandarin."),
  },
];
